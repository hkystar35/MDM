...
| **ADE Automatic User Creation from Identity Provider (IdP), like OIDC, Entra ID, Okta, Google Worksapce,etc)** | Enrollment | macOS | :white_check_mark::heavy_dollar_sign: | :white_check_mark::heavy_dollar_sign: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :x: |
...
| **Sandbox instance** | Sandbox | Server Infrastructure | :x: | :white_check_mark: | :heavy_dollar_sign: | :x: | :x: | :x: | :white_check_mark: |
